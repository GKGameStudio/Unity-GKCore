...
namespace GKCore.Observers
{
    ...
    public class ObservableVar<T>
    {
        ...
        public ObservableVar(T value, UnityAction<T, T> changedCallback = null)
        {
            _value = value;
        ...
        public void AddListener(UnityAction<T, T> action)
        {
            ...
            if (_changed == null) _changed = new UnityEvent<T, T>();
        ...
        {
            return Equals(obj as ObservableVar<T>);
        }

        public bool Equals(ObservableVar<T> other)
        {
        ...
        /// </summary>
        public void InvokeChanged(T oldValue, T newValue)
        {
            try
            {
                _changed?.Invoke(oldValue, newValue);
            }
            catch (Exception e)
            {
        ...
        public void Set(T value, bool invokeChanged = true)
        {
            ...
            T oldValue = _value;
            _value = value;
            if (invokeChanged) InvokeChanged(oldValue, _value);
        }
        ...
        public static bool operator ==(ObservableVar<T> a, ObservableVar<T> b)
        {
        ...
        public static bool operator ==(ObservableVar<T> a, T b)
        {
        ...
        public static implicit operator T(ObservableVar<T> value)
        {
            return value.Value;
        }
        
        public static ObservableVar<T> operator +(ObservableVar<T> value, UnityAction<T, T> action)
        {
